...
# =============================================================================
# GenesFaaPath = sys.argv[1]
# OrthofResultsPath = sys.argv[2]
# ShortGeneID = sys.argv[3]
# WriteAllGenes = sys.argv[4]
# pipeNames=sys.argv[5]

# PathAlignedOG="/Users/garancesarton-loheac/Documents/PhD/Phylogenies/ForPublication/Acetobacteraceae/04_Aligned_OG"
# OutDir= "/Users/garancesarton-loheac/Documents/PhD/Phylogenies/ForPublication/Acetobacteraceae/05_Whole_Alignments"
# WriteAll=True # do we need to write all pruned allPrunedSequences
# pipeNames='True'


PathAlignedOG=sys.argv[1] #/user/gsartonl/scratch/gsartonl/SAGE_II/01_Aligned_OG
OutDir=sys.argv[2] # "/Users/garancesarton-loheac/Documents/Teaching/SAGE_2021/SAGE_II/02_Whole_Alignments"
WriteAll=True # do we need to write all pruned allPrunedSequences
